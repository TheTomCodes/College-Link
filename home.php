        ...
        <div class="max-w-sm mx-auto bg-white  border-2 border-blue-700 rounded-lg overflow-hidden shadow-2xl">
            <div class=" px-4 pb-6">
                ...
                <div class="flex gap-2 px-2">
                    <button 
                        class=" w-full px-6 py-3 text-sm font-serif tracking-wide text-white text-white capitalize transition-colors duration-300 transform bg-blue-700 rounded-lg hover:bg-blue-900"><a href="StudentUpdate_Profile.php">
                        Update Profile</a>
                    </button>
                    <button
                        class=" w-full px-6 py-3 text-sm font-serif tracking-wide text-white text-white capitalize transition-colors duration-300 transform bg-blue-700 rounded-lg hover:bg-blue-900"><a href="index.php">
                        Get Start
                    </button>
                </div>
            </div>
