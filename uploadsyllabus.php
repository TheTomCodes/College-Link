...
<h1 class="font-serif text-2xl md:text-6xl text-center text-blue-700 mt-6 mb-6">Syllabus</h1>
<div class="flex flex-wrap justify-center mx-auto ">
    <?php
   $sql = "SELECT id, filename, classid, upload_date FROM syllabus ";
   // fire query
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
       if (isset($_POST['delete_id'])) {
           ...
           $delete_sql = "DELETE FROM syllabus WHERE id = '$delete_id'";
    ...
    <div class="container flex items-center justify-center  px-6 mx-auto">
        <form class="w-full max-w-md"method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
            ...
            <div class="flex justify-center mx-auto">
                <h1 class="text-3xl font-serif">UploadSyllabus</h1>
            </div>
    ...
    if (isset($_FILES["file"]) && $_FILES["file"]["error"] == 0) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO syllabus (filename, filesize, filetype, classid) VALUES ('$filename', $filesize, '$filetype','$classidtype')";
