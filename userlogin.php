...
if(isset($_POST['submit'])){
   ...
   $select = mysqli_query($conn, "SELECT * FROM `student_form` WHERE email = '$email' AND password = '$encrypted_password'") or die('query failed');
    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md" action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-center mt-12">
                ...
                <a href="userlogin.php" class="w-1/3 pb-4 font-serif text-xl text-center text-blue-700 capitalize border-b-2 border-gray-900 hover:border-blue-700 ">
                    sign In
                </a>
            </div>
