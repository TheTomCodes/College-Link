...
// Fetch the uploaded files from the database based on classId
$sql = "SELECT * FROM studentresult WHERE classId = $classId";
...
<div class="flex flex-wrap justify-center mx-auto ">
    ...
    ?>
            <div class=" w-96 mx-4 my-4 p-6 bg-white border border-gray-200 rounded-lg shadow text-start">
                ...
                <p class="font-mono text-lg text-gray-700">StudentID: <?php echo $row['studentid']; ?> </p>
                <p class="font-mono text-lg text-gray-700">Class: <?php echo $row['classname']; ?></p>
                <p class="font-mono text-lg text-gray-700">PaperType: <?php echo $row['Papertype']; ?></p>
                <p class="mb-8 font-mono text-lg text-gray-700">Date: <?php echo $row['upload_date']; ?></p>
                <a href="<?php echo $file_path; ?>" class="block bg-blue-700 text-white font-serif py-2 px-4 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 transition duration-300 ease-in-out transform hover:scale-105 text-center">
                    Download
